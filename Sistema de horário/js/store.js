...
class Store {
  ...
  getDefaultSeptember2026Schedule() {
    const days = {
      // Semana 1 (01 a 06/09): Manhã (Matheus + Salete) / Noite (Livia + Natália)
      ...
      "2026-09-04": { dayNumber: 4, dayOfWeek: 5, slots: [{ workers: [{ employeeName: 'MATHEUS', color: 'NORMAL' }, { employeeName: 'SALETE', color: 'NORMAL' }] }, { workers: [] }, { workers: [{ employeeName: 'LIVIA', color: 'GREEN' }, { employeeName: 'NATÁLIA', color: 'GREEN' }] }] },
      ...
      // Semana 2 (07 a 13/09): Manhã (Livia + Natália) / Noite (Matheus + Salete)
      "2026-09-07": { dayNumber: 7, dayOfWeek: 1, slots: [{ workers: [{ employeeName: 'LIVIA', color: 'NORMAL' }, { employeeName: 'NATÁLIA', color: 'NORMAL' }] }, { workers: [] }, { workers: [{ employeeName: 'MATHEUS', color: 'NORMAL' }, { employeeName: 'SALETE', color: 'NORMAL' }] }] },
      "2026-09-08": { dayNumber: 8, dayOfWeek: 2, slots: [{ workers: [{ employeeName: 'LIVIA', color: 'NORMAL' }, { employeeName: 'NATÁLIA', color: 'NORMAL' }] }, { workers: [] }, { workers: [{ employeeName: 'MATHEUS', color: 'NORMAL' }, { employeeName: 'SALETE', color: 'NORMAL' }] }] },
      "2026-09-09": { dayNumber: 9, dayOfWeek: 3, slots: [{ workers: [{ employeeName: 'LIVIA', color: 'NORMAL' }, { employeeName: 'NATÁLIA', color: 'NORMAL' }] }, { workers: [] }, { workers: [{ employeeName: 'MATHEUS', color: 'NORMAL' }, { employeeName: 'SALETE', color: 'NORMAL' }] }] },
      "2026-09-10": { dayNumber: 10, dayOfWeek: 4, slots: [{ workers: [{ employeeName: 'LIVIA', color: 'NORMAL' }, { employeeName: 'NATÁLIA', color: 'NORMAL' }] }, { workers: [] }, { workers: [{ employeeName: 'MATHEUS', color: 'NORMAL' }, { employeeName: 'SALETE', color: 'NORMAL' }] }] },
      "2026-09-11": { dayNumber: 11, dayOfWeek: 5, slots: [{ workers: [{ employeeName: 'LIVIA', color: 'NORMAL' }, { employeeName: 'NATÁLIA', color: 'NORMAL' }] }, { workers: [] }, { workers: [{ employeeName: 'MATHEUS', color: 'GREEN' }, { employeeName: 'SALETE', color: 'GREEN' }] }] },
      ...
      // Semana 3 (14 a 20/09): Manhã (Matheus + Salete) / Noite (Livia + Natália)
      ...
      "2026-09-18": { dayNumber: 18, dayOfWeek: 5, slots: [{ workers: [{ employeeName: 'MATHEUS', color: 'NORMAL' }, { employeeName: 'SALETE', color: 'NORMAL' }] }, { workers: [] }, { workers: [{ employeeName: 'LIVIA', color: 'GREEN' }, { employeeName: 'NATÁLIA', color: 'GREEN' }] }] },
      ...
      // Semana 4 (21 a 27/09): Manhã (Livia + Natália) / Noite (Matheus + Salete)
      ...
      "2026-09-25": { dayNumber: 25, dayOfWeek: 5, slots: [{ workers: [{ employeeName: 'LIVIA', color: 'NORMAL' }, { employeeName: 'NATÁLIA', color: 'NORMAL' }] }, { workers: [] }, { workers: [{ employeeName: 'MATHEUS', color: 'GREEN' }, { employeeName: 'SALETE', color: 'GREEN' }] }] },
      ...
      // Semana 5 (28 a 30/09): Manhã (Matheus + Salete) / Noite (Livia + Natália)

...
class Store {
  ...
  getDefaultSeptember2026Schedule() {
    const days = {
      // Semana 1 (01 a 06/09): Continuação de 31/08 - Manhã (Matheus + Salete) / Noite (Livia + Natália) - 1ª Sexta (Folga Verde Livia)
      ...
      // Semana 2 (07 a 13/09): Manhã (Livia + Natália) / Noite (Matheus + Salete) - 2ª Sexta (Folga Verde Matheus)
      ...
      "2026-09-11": { dayNumber: 11, dayOfWeek: 5, slots: [{ workers: [{ employeeName: 'LIVIA', color: 'NORMAL' }, { employeeName: 'NATÁLIA', color: 'NORMAL' }] }, { workers: [{ employeeName: 'MATHEUS', color: 'GREEN' }] }, { workers: [{ employeeName: 'SALETE', color: 'NORMAL' }] }] },
      ...
      // Semana 4 (21 a 27/09): Manhã (Livia + Natália) / Noite (Matheus + Salete) - 4ª Sexta (Folga Verde Salete)
      ...
      "2026-09-25": { dayNumber: 25, dayOfWeek: 5, slots: [{ workers: [{ employeeName: 'LIVIA', color: 'NORMAL' }, { employeeName: 'NATÁLIA', color: 'NORMAL' }] }, { workers: [{ employeeName: 'SALETE', color: 'GREEN' }] }, { workers: [{ employeeName: 'MATHEUS', color: 'NORMAL' }] }] },
